...
const Point GLDisplayWidget::CAMERA_POSITION = Point(0, 0, 5);

//GLDisplayWidget::GLDisplayWidget(QWidget *parent) : QGLWidget(parent), _X(0.f), _Y(0.f),_Z(0.f), _angle(0.f)
GLDisplayWidget::GLDisplayWidget(QOpenGLWidget* parent) : QOpenGLWidget(parent), _X(0.f), _Y(0.f),_Z(0.f), _angle(0.f)
  //UpgradeQt6: replace by : QOpenGLWidget(parent)
{
    // Update the scene
    //connect( &_timer, SIGNAL(timeout()), this, SLOT(updateGL())); //UpgradeQt6:
